...
const TimeOffRequestsPage = ({ employees, permission }) => {
  ...
  return (
    <div className="p-4">
      ...
      <p className="mb-4">
        Note: Make sure to properly configure the workflow for time off requests
        to ensure a smooth process for employees and managers.
      </p>
      <div className="mb-4">
        <label className="block text-gray-700 mb-5">
          Who can approve time off requests for an employee?
        </label>
        <IconSelect
          width={230}
      ...
      {(permission?.approver !== selectedApprover ||
        ...
        <button
          ...
          onClick={() => {
            ...
            updatePermission({
              permissionName: "timeOffRequests",
