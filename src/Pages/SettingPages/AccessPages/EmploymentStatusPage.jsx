...
const EmploymentStatusPage = ({ employees, permission }) => {
  ...
  return (
    <div className="p-4">
      ...
      <p className="mb-4">
        Note: Ensure the proper workflow is in place for updating employment
        statuses, to maintain accurate records.
      </p>
      <div className="mb-4">
        <label className="block text-gray-700 mb-5">
          Who can approve employment status updates for an employee?
        </label>
        <IconSelect
          width={230}
      ...
      {(permission?.approver !== selectedApprover ||
        ...
        <button
          ...
          onClick={() => {
            ...
            updatePermission({
              permissionName: "employmentStatus",
